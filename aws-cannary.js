...
const flowBuilderBlueprint = async function () {
    ...
    let url = `https://master.ddrds5o5uggip.amplifyapp.com/#/arise/accm/f922f8df?c_in=${getYYYYMMDD(checkin)}&c_out=${getYYYYMMDD(new Date(checkin).setDate(new Date().getDate() + 1) )}&currency=LKR&adult=2&child=0`;
